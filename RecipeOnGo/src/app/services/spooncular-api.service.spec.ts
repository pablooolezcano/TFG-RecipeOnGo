...
describe('SpooncularApiService', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [HttpClientTestingModule], // Configura HttpClientModule aquí
            providers: [SpooncularApiService],
        });
    ...
    it('should make an API call', () => {
        ...
        service.getOneRecipeInfo(716429).subscribe((response) => {
            let arrayRes = Object.entries(response);
            console.log('result: ', arrayRes[0][1])
            expect(response).toBeTruthy();
            expect(response).toHaveSize(1);
            expect(arrayRes[0][1]).toBe(mockResponse[0])
        });

        const mockRequest = httpTestingController.expectOne(
            'https://api.spoonacular.com/recipes/716429/information?apiKey=15b9af73d0d44a19b7cc19073dfcf8a9'
        );
